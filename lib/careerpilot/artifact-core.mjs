...
const LEGACY_RESUME_STYLES = new Set([
  'compact-photo', 'compact-no-photo', 'technical-two-page',
  'soe-blue-standard', 'soe-navy-dense', 'soe-red-academic', 'soe-research-formal', 'technical-minimal',
]);
...
export function validateResumeArtifactManifest(manifest) {
  ...
  if (LEGACY_RESUME_STYLES.has(manifest?.resume_style)) errors.push({ code: 'legacy_resume_style_not_valid_for_campaign' });

...
Issues and PRDs are tracked in GitHub Issues for `gaosanliukoushui/career-pilot-cn`; external PRs are not a triage request surface. See `docs/agents/issue-tracker.md`.

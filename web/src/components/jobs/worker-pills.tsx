  ...
  return (
    <div className="mt-4 border-t border-border pt-3">
      <div className="mb-2 flex items-center gap-2 px-1">
        <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-faint">后台任务</span>
        {running > 0 && <span className="text-[10px] tabular-nums text-brand">{running} 个运行中</span>}
        <Link href="/jobs" className="ml-auto text-faint transition-colors hover:text-foreground" title="历史记录" aria-label="任务历史记录">
